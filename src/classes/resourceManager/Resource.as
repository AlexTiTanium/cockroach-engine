...
package classes.resourceManager
{
	...
	import classes.resourceManager.ResourceEvent;
     ...
     */
    [Event(name="LOADED_EVENT", type="classes.resourceManager.ResourceEvent")]
    
    /**
     * @eventType com.pblabs.engine.resource.ResourceEvent.FAILED_EVENT
     */
    [Event(name="FAILED_EVENT", type="classes.resourceManager.ResourceEvent")]
    ...
    {	
        ...
        public function set filename(value:String):void
        {
            if (_filename != null)
            {
                throw new Error("set filename", "Can't change the filename of a resource once it has been set.");
                return;
            }
        ...
        protected function onLoadComplete(event:Event = null):void
        {
            ...
            {
               trace("Load", "Failed to load! " + e.toString());
            }
        ...
        protected function onFailed(message:String):void
        {
            _isLoaded = true;
            _didFail = true;
			trace("Load", "Resource " + _filename + " failed to load with error: " + message);
