    ...
    public class TypeUtility
    {
        ...
        public static function registerInstantiator(typeName:String, instantiator:Function):void
        {
            if (_instantiators[typeName])
                trace( "An instantiator for " + typeName + " has already been registered. It will be replaced.");
        ...
        public static function instantiate(className:String, suppressError:Boolean = false):*
        {
            ...
            {												
                if(!suppressError)
                {
                    ...
                    trace("Failed to instantiate " + className + " due to " + e.toString());
                    trace("Is " + className + " included in your SWF? Make sure you call PBE.registerType(" + className + "); somewhere in your project.");				 
                }
            }
        ...
        public static function isDynamic(object:*):Boolean
        {
            if (object is Class)
            {
                trace("The object is a Class type, which is always dynamic");
                return true;
            }
